...
Contributions to Journal include code, documentation, answering user questions,
running the project's infrastructure, and advocating for all types of users.

The Journal project welcomes all contributions from anyone willing to work in
good faith with other contributors and the community. No contribution is too
small and all contributions are valued.

This guide explains the process for contributing to the Journal project's core
`dhanushuUzumaki/Journal` GitHub Repository and describes what to expect at each step.

## [Code of Conduct](./CODE_OF_CONDUCT.md)

The Journal project has a
[Code of Conduct](https://github.com/dhanushuUzumaki/Journal/blob/master/CODE_OF_CONDUCT.md)
that *all* contributors are expected to follow. This code describes the
*minimum* behavior expectations for all contributors.

See [details on our policy on Code of Conduct](https://github.com/dhanushuUzumaki/Journal/blob/master/CODE_OF_CONDUCT.md).

## [Issues](./doc/guides/contributing/issues.md)

Issues in Journal are the primary means by which bug reports and
