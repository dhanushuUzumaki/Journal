...
1. By opening the issue for discussion: For instance, if you believe that you
   have uncovered a bug in Journal App, creating a new issue in the `dhanushuUzumaki/Journal`
...
3. By helping to resolve the issue: Typically this is done either in the form
   ...
   `dhanushuUzumaki/Journal` in a concrete and reviewable manner.

## Asking for General Help

Questions or requests for general help using Journal should be done through mail <a.p.dhanushu@gmail.com>

## Discussing non-technical topics

Discussion of non-technical topics (such as intellectual property and trademark)
should be directed to the mail <a.p.dhanushu@gmail.com>.

## Submitting a Bug Report

When opening a new issue in the `dhanushuUzumaki/Journal` issue tracker, users will be
...
If you believe that you have uncovered a bug in Journal, please fill out this
...
functional guidelines of the Journal project.
